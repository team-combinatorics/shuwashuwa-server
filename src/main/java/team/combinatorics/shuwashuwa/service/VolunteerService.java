...
public interface VolunteerService {
     ...
     * @return 申请表摘要信息列表
     */
    List<VolunteerApplicationAbstractDTO> listVolunteerApplicationByCondition(SelectApplicationCO selectApplicationCO);
     ...
     * @param formId 申请表的id
     */
    void getApplicationDetailByFormId(int formId);
